...
set_cache_default(NRF5SDK__NRFX_NVMC_ENABLED FALSE BOOL "")
...
set_cache_default(NRF5SDK__CONFIG_NFCT_PINS_AS_GPIOS FALSE BOOL "")
...
if(NRF5SDK__NRFX_NVMC_ENABLED)
    add_definitions("-DNRFX_NVMC_ENABLED")
endif(NRF5SDK__NRFX_NVMC_ENABLED)
...
if(NRF5SDK__CONFIG_NFCT_PINS_AS_GPIOS)
    add_definitions("-DCONFIG_NFCT_PINS_AS_GPIOS")
endif(NRF5SDK__CONFIG_NFCT_PINS_AS_GPIOS)
